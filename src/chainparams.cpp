 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1735923145, nBits=1e0ffff0, nNonce=1397685, vtx=1)
...
{
    const char* pszTimestamp = "The Times is 01 03 2025 ";
    const CScript genesisOutputScript = CScript() << ParseHex("042ab4379ea332f5cbf74c32edf8a42446171d11e386261ab9c2b3632ccb5eefd4f673e890db63171cbf99a6bbe73b03e0a009c48a526458cf61207cbd137a6e01") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000ac8ea250507796d6fe312e8be6c5348e5a908a161a420705226c5cf7050"); 
        ...
        genesis = CreateGenesisBlock(1735923145, 1397685, 0x1e0ffff0, 1, 3 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000ac8ea250507796d6fe312e8be6c5348e5a908a161a420705226c5cf7050"));
        assert(genesis.hashMerkleRoot == uint256S("0x1882ebc259948f01bc095f1071b4d1c67368be4ec12fbefb47e3b8b12fbc512f"));
        ...
        // EGamingCoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // EGamingCoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // EGamingCoin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"ETFd4Ubf3cdZHJe1qLRWqSXe3zA4zEXstY"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000ac8ea250507796d6fe312e8be6c5348e5a908a161a420705226c5cf7050")},
            }
        };
        ...
        // getchaintxstats 17280 00000ac8ea250507796d6fe312e8be6c5348e5a908a161a420705226c5cf7050
        chainTxData = ChainTxData{
                1735923145, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000066602317830e6ae0db5e218295c398d59275123474a6d55546dacbf717d"); 
        ...
        genesis = CreateGenesisBlock(1735923150UL, 133422UL, 0x1e0ffff0, 1, 3 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000066602317830e6ae0db5e218295c398d59275123474a6d55546dacbf717d"));
        assert(genesis.hashMerkleRoot == uint256S("0x1882ebc259948f01bc095f1071b4d1c67368be4ec12fbefb47e3b8b12fbc512f"));
        ...
        // Testnet EGamingCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet EGamingCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet EGamingCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"MJ512fHwM4rzcZvRrLYGXwD2iYjnEjse1y"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x0000066602317830e6ae0db5e218295c398d59275123474a6d55546dacbf717d")},
            }
        };
        ...
        // getchaintxstats 17280 0000066602317830e6ae0db5e218295c398d59275123474a6d55546dacbf717d
        chainTxData = ChainTxData{
                1735923150, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1735923155, 0, 0x207fffff, 1, 3 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x1f226f85f3b1e151cc6c3e711cb702ee83b53130761b69965cdaa4dfcf23ba03"));
        assert(genesis.hashMerkleRoot == uint256S("0x1882ebc259948f01bc095f1071b4d1c67368be4ec12fbefb47e3b8b12fbc512f"));

        devnetGenesis = FindDevNetGenesisBlock(genesis, 3 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x1f226f85f3b1e151cc6c3e711cb702ee83b53130761b69965cdaa4dfcf23ba03")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 6ygHDctdtH4qC9inDjj1qs8ErrT3JoGFAV1dc9uY8cxRYueiekH
        vSporkAddresses = {"MQSQQu1ZBr7AsMbhg2q9dRSfX1N71VRMF4"};
        nMinSporkKeys = 1;
        ...
        // Regtest EGamingCoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,50);
        // Regtest EGamingCoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,51);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,178);
        // Regtest EGamingCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest EGamingCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest EGamingCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;

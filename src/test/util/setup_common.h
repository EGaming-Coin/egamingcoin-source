...
/* Initialize EGamingCoin-specific components after chainstate initialization */
void EGamingCoinTestSetup(NodeContext& node);
void EGamingCoinTestSetupClose(NodeContext& node);

...
/** Utility functions used by the EGamingCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    */
    ...
    /** Load egamingcoin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a egamingcoin specific theme is activated (light/dark).*/

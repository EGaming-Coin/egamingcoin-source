...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a EGamingCoin address"));
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a EGamingCoin address").arg(strCoinJoinName));
    coinJoinCoinsMenuAction->setToolTip(coinJoinCoinsMenuAction->statusTip());

    receiveCoinsMenuAction = new QAction(tr("&Receive"), this);
    receiveCoinsMenuAction->setStatusTip(tr("Request payments (generates QR codes and egamingcoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EGamingCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EGamingCoin addresses"));
    m_load_psbt_action = new QAction(tr("Load PSBT..."), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed EGamingCoin Transaction"));
    ...
    openAction->setStatusTip(tr("Open a egamingcoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible EGamingCoin command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateWidth()
{
    ...
    // Use nButtonsVisible + 1 <- for the egamingcoin logo

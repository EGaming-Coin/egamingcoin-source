...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"egamingcoin\" activates all EGamingCoin-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "egamingcoin")
    + HelpExampleRpc("debug", "egamingcoin+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The egamingcoin address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The egamingcoin address to use for the signature."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of EGNm"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of EGNm of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in EGNm"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in EGNm"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in EGNm"},
                    {RPCResult::Type::NUM, "received", "The total number of EGNm received (including change)"},
                }},
        RPCExamples{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "egamingcoin-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* EGamingCoin features */
    { "egamingcoin",               "mnsync",                 &mnsync,                 {} },
    { "egamingcoin",               "spork",                  &spork,                  {"command"} },
    { "egamingcoin",               "sporkupdate",            &sporkupdate,            {"name","value"} },

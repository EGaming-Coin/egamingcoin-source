 ...
 *  We have 4 times smaller block times in EGamingCoin, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        EGamingCoin Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // EGN this code also handles non-TXs (EGamingCoin specific messages)

...
//! Interface for the src/evo part of a egamingcoin node (egamingcoind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a egamingcoin node (egamingcoind process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a egamingcoin node (egamingcoind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a egamingcoin node (egamingcoind process).
...
//! Top-level interface for a egamingcoin node (egamingcoind process).
class Node
{
public:
    virtual ~Node() {}

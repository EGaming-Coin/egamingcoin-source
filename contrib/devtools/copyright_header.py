...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The EGamingCoin Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a EGamingCoin Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The EGamingCoin Core developers'
...
Arguments:
    <base_directory> - The base directory of EGamingCoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the EGamingCoin Core repository.
"""

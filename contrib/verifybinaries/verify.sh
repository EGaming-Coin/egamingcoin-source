...
RCSUBDIR="test"
HOST1="/releases/download/v"
HOST2="https://pasta.keybase.pub/EGamingCoin-Core-Releases/"
BASEDIR=""
VERSIONPREFIX=""
RCVERSIONSTRING="rc"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the EGamingCoin Core binary release signing key installed?"
   fi

...
official/supported Docker Images found at https://hub.docker.com/r/egamingcoinpay/egamingcoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/egamingcoinpay/egamingcoind-develop/ when changing the above text**
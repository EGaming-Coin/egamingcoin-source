...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: EGamingCoin's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'EGamingCoin', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']

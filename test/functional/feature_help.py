...
"""Verify that starting egamingcoind with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start egamingcoind with -h for help text")
        ...
        self.log.info("Start egamingcoind with -version for version information")
        ...
        self.log.info("Start egamingcoindd with -fakearg to make sure it does not start")

EGamingCoin Core version 0.16.1.0
==========================
...
- Starting EGamingCoin Core compiled without wallet support or with `-disablewallet` command line
...
See detailed [set of changes](/compare/v0.16.0.1...egamingcoinpay:v0.16.1.0).

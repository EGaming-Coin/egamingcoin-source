EGamingCoin Core version 0.13.3.0
==========================
...
from anti virus software. Linux builds are not affected. The mining code found in `egamingcoin-qt` and `egamingcoind` are only meant
...
See detailed [set of changes](/compare/v0.13.2.0...egamingcoinpay:v0.13.3.0).

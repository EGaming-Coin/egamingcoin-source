EGamingCoin Core version 0.14.0.4
==========================
...
A bug in EGamingCoin Core caused respends to not work before a received InstantSend transaction was confirmed in at least
one block. This is fixed in this release, so that InstantSend locked mempool transactions can be
respent immediately in EGamingCoin Core (other wallets were not affected).
...
Previously, EGamingCoin would re-request old transactions even though they were already known locally. This
...
in Bitcoin v0.15.1. This release of EGamingCoin Core includes a backport of this fix.


0.14.0.4 Change log
===================

See detailed [set of changes](/compare/v0.14.0.3...egamingcoinpay:v0.14.0.4).

...
- [`c8e5c40ec`](/commit/c8e5c40ec) Replace more example EGamingCoin addresses with invalid addresses
...
- [`997f9f795`](/commit/997f9f795) EGamingCoinify build-windows.md
...
- [`d0a39fbcf`](/commit/d0a39fbcf) Use "EGamingCoin Core" instead of "egamingcoin-core" in some places and EGamingCoinify
...
- [`5496e468a`](/commit/5496e468a) EGamingCoinify a few docs and the use of an address
...
- [`18da34e29`](/commit/18da34e29) Merge #7761: [Qt] remove trailing output-index from transaction-id
- [`1c8441778`](/commit/1c8441778) Merge #7573: P2P: add maxtimeadjustment command line option
- [`a9a209f58`](/commit/a9a209f58) Merge #7723: build: python 3 compatibility
- [`ba65eb1ac`](/commit/ba65eb1ac) Merge #7764: [qa] Don't run pruning.py twice
- [`a309bf372`](/commit/a309bf372) Clear setInternalKeyPool and setExternalKeyPool instead of setKeyPool
- [`e2fefa539`](/commit/e2fefa539) Merge #7558: [RPC] Add import/removeprunedfunds rpc call
- [`ca33635ef`](/commit/ca33635ef) Merge #7742: [Wallet][RPC] add missing abandon status documentation
- [`34701da5c`](/commit/34701da5c) Merge #7737: devtools: make github-merge.py use py3
- [`a4911c383`](/commit/a4911c383) Merge #7646: Fix lockunspent help message
- [`f933c6726`](/commit/f933c6726) Merge #7715: Fix calculation of balances and available coins.
- [`760d58e3d`](/commit/760d58e3d) Merge #7671: [RPC] Add generatetoaddress rpc to mine to an address
- [`953aeead1`](/commit/953aeead1) Merge #7710: [Depends] Bump miniupnpc and config.guess+sub
- [`74fe8fe59`](/commit/74fe8fe59) Merge #7649: Prevent multiple calls to CWallet::AvailableCoins
- [`aa584522d`](/commit/aa584522d) EGamingCoin related changes for feefilter
- [`11ac70af9`](/commit/11ac70af9) Merge #7542: Implement "feefilter" P2P message
- [`283922243`](/commit/283922243) Merge #7726: Correct importaddress help reference to importpubkey
- [`04bf554ab`](/commit/04bf554ab) Merge #7712: Improve COutPoint less operator
- [`f4d30a645`](/commit/f4d30a645) Merge #7708: De-neuter NODE_BLOOM
- [`8fde2fd5f`](/commit/8fde2fd5f) Merge #7705: [amount] Add tests and make GetFee() monotonic
- [`721171ee3`](/commit/721171ee3) Merge #7686: [qt] Remove 0-fee from send dialog
- [`29d263389`](/commit/29d263389) Merge #7594: Mempool: Add tracking of ancestor packages
- [`49a8ed6d3`](/commit/49a8ed6d3) Merge #7683: Fix torcontrol.cpp unused private field warning
- [`abbbe61d0`](/commit/abbbe61d0) Merge #7608: [wallet] Move hardcoded file name out of log messages
- [`5f9bfa0b6`](/commit/5f9bfa0b6) Merge #7670: use cached block hash in blockToJSON()
- [`fb4ec255c`](/commit/fb4ec255c) Merge #7663: Make the generate RPC call function for non-regtest
- [`fa0341115`](/commit/fa0341115) Merge #7507: Remove internal miner
- [`332fbfc0e`](/commit/332fbfc0e) HDWallet fixes after moving wallet initialization
- [`b3525b2e6`](/commit/b3525b2e6) Merge #7577: [Wallet] move "load wallet phase" to CWallet
- [`8be396a3b`](/commit/8be396a3b) Merge #7667: Move GetTempPath() to testutil
- [`f1e95e358`](/commit/f1e95e358) Merge #7635: [Documentation] Add dependency info to test docs
- [`51c6ab20f`](/commit/51c6ab20f) Merge #7576: [Wallet] move wallet help string creation to CWallet
- [`24cf36972`](/commit/24cf36972) Merge #7592: mempool: Re-remove ERROR logging for mempool rejects
- [`23eeaeef8`](/commit/23eeaeef8) Merge #7662: remove unused NOBLKS_VERSION_{START,END} constants
- [`00d42b7c9`](/commit/00d42b7c9) Merge #7539: Add tags to mempool's mapTx indices
- [`d6a0de72a`](/commit/d6a0de72a) fix splashscreen (shrink titleCopyrightVSpace)
- [`af5aece96`](/commit/af5aece96) make CopyrightHolders more generic
- [`4e0bb527d`](/commit/4e0bb527d) Merge #8373: Fix OSX non-deterministic dmg
- [`51ca0d5b4`](/commit/51ca0d5b4) Move privatesend to rpcwallet.cpp as well after Bitcoin #7307 was backported
- [`02785c858`](/commit/02785c858) Disable check-doc.py for now until all backported PRs are merged and docs fixed
- [`48eddeea2`](/commit/48eddeea2) Merge #7455: [travis] Exit early when check-doc.py fails
- [`07338feae`](/commit/07338feae) Merge #7620: [travis] Only run check-doc.py once
- [`266520ced`](/commit/266520ced) Merge #7632: Delete outdated test-patches reference
- [`eed9428d2`](/commit/eed9428d2) Merge #7616:  [depends] Delete unused patches
- [`74eda8759`](/commit/74eda8759) Merge #7537: wallet: Warn on unexpected EOF while salvaging wallet
- [`5390a1a0a`](/commit/5390a1a0a) Merge #7590: Improving wording related to Boost library requirements [updated]
- [`f0300c6c5`](/commit/f0300c6c5) Merge #7606: [depends] builders: No need to set -L and --location for curl
- [`a890c7616`](/commit/a890c7616) Merge #7612: [doc] Typo fix
- [`984dc5271`](/commit/984dc5271) Merge #7619: Add missing sudo entry in gitian VM setup.
- [`6a121275d`](/commit/6a121275d) Merge #7583: [doc] Fix typos
- [`97c7da4b7`](/commit/97c7da4b7) Merge #7509: Common argument defaults for NODE_BLOOM stuff and -wallet
- [`ee5f8d211`](/commit/ee5f8d211) Merge #7536: test: test leading spaces for ParseHex
- [`cd7a2e2b5`](/commit/cd7a2e2b5) Merge #7504: Crystal clean make clean
- [`529e8ad63`](/commit/529e8ad63) Merge #7528: autogen.sh: warn about needing autoconf if autoreconf is not found
- [`de91ef95f`](/commit/de91ef95f) Merge #7490: tests: Remove May15 test
- [`7ec1e1887`](/commit/7ec1e1887) Merge #7459: Consensus: Decouple pow.o from util.o
- [`8874b2e0f`](/commit/8874b2e0f) Merge #6480: include the chaintip blockindex in the SyncTransaction signal, add signal UpdateTip()
- [`a3d1e5eda`](/commit/a3d1e5eda) Merge #7070: Move maxTxFee out of mempool
- [`e7a6f79e5`](/commit/e7a6f79e5) Merge #7192: Unify product name to as few places as possible
- [`0f8ce5688`](/commit/0f8ce5688) Merge #7444: Improve block validity/ConnectBlock() comments
- [`bcbd2cda2`](/commit/bcbd2cda2) Merge #7091: Consensus build package
- [`0afbd1c3d`](/commit/0afbd1c3d) Merge #7084: mempool: Replace maxFeeRate of 10000*minRelayTxFee with maxTxFee
- [`a65f7b7a7`](/commit/a65f7b7a7) Merge #7311: MOVEONLY: Move non-consensus functions out of pow
- [`c8e04d43f`](/commit/c8e04d43f) Add missing comment in net.cpp
- [`5f68e06a0`](/commit/5f68e06a0) Add missing whitelistalwaysrelay arg to SET_DOC_OPTIONAL
- [`6789bf6e1`](/commit/6789bf6e1) Merge #7287: Consensus: Remove calls to error() and FormatStateMessage()
- [`3cd83db0d`](/commit/3cd83db0d) Merge #7441: Use Debian 8.3 in gitian build guide
- [`c5f84c4e6`](/commit/c5f84c4e6) Merge #6842: limitfreerelay edge case bugfix
- [`6c5286aad`](/commit/6c5286aad) Merge #7423: doc: add example for building with constrained resources
- [`2fd5d93a9`](/commit/2fd5d93a9) Merge #7437: GUI: Disable tab navigation for peers tables.
- [`b277eed58`](/commit/b277eed58) Merge #7425: devtools: Fix utf-8 support in messages for github-merge
- [`5323a08af`](/commit/5323a08af) Merge #7300: [trivial] Add missing copyright headers
- [`577f683c5`](/commit/577f683c5) Merge #7402: [devtools] github-merge get toplevel dir without extra whitespace
- [`d9d9e95e4`](/commit/d9d9e95e4) Merge #7395: devtools: show pull and commit information in github-merge
- [`85919332d`](/commit/85919332d) Merge #7236: Use createrawtx locktime parm in txn_clone
- [`643181fe1`](/commit/643181fe1) Merge #7262: Reduce inefficiency of GetAccountAddress()
- [`43700eef3`](/commit/43700eef3) Merge #7383: [Qt] rename "amount" to "requested amount" in receive coins table
- [`59db2fda1`](/commit/59db2fda1) Merge #7183: Improved readability of ApproximateBestSubset
- [`78ad32d10`](/commit/78ad32d10) Merge #7307: [RPC, Wallet] Move RPC dispatch table registration to wallet/ code
- [`3be77849d`](/commit/3be77849d) Merge pull request #7378
- [`42997ee8d`](/commit/42997ee8d) Merge pull request #7280
- [`2474fd0ae`](/commit/2474fd0ae) Merge pull request #7208
- [`723eacf45`](/commit/723eacf45) Merge pull request #7290
- [`25ba3aba1`](/commit/25ba3aba1) Merge pull request #7304
- [`38080259b`](/commit/38080259b) Merge pull request #7313
- [`26a5dfe33`](/commit/26a5dfe33) Merge pull request #7326
- [`5ca9b1a9c`](/commit/5ca9b1a9c) Merge pull request #7317
- [`bcebc7c4c`](/commit/bcebc7c4c) Merge pull request #7266
- [`f04f8c19d`](/commit/f04f8c19d) Merge pull request #7257
- [`3f6d6572f`](/commit/3f6d6572f) Merge pull request #7156
- [`bf688abce`](/commit/bf688abce) Merge pull request #7113
- [`f1da40c87`](/commit/f1da40c87) Merge #7550: rpc: Input-from-stdin mode for bitcoin-cli
- [`f8407083c`](/commit/f8407083c) Remove duplicated CCACHE= line in depends/config.site.in

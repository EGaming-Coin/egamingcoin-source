# EGamingCoin Core version v19.3.0
...
- `wipetxes`: New command for `egamingcoin-wallet` that removes all wallet transactions
...
See detailed [set of changes](/compare/v19.2.0...egamingcoinpay:v19.3.0).

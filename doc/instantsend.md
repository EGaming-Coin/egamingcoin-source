...
This mechanism has been integrated into Bitcore-Node-EGamingCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/egamingcoinpay/insight-api-egamingcoin#web-socket-api](https://github.com/egamingcoinpay/insight-api-egamingcoin#web-socket-api)
* API: [https://github.com/egamingcoinpay/insight-api-egamingcoin#instantsend-transactions](https://github.com/egamingcoinpay/insight-api-egamingcoin#instantsend-transactions)

...
This document provides guidelines for internationalization of the EGamingCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `egamingcoin_en.ts` remains unchanged.

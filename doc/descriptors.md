# Support for Output Descriptors in EGamingCoin Core

Since EGamingCoin Core v0.17, there is support for Output Descriptors. This is a
...
existing EGamingCoin Core wallets, a convenience function `combo` is
...
All RPCs in EGamingCoin Core will include the checksum in their output. Only
